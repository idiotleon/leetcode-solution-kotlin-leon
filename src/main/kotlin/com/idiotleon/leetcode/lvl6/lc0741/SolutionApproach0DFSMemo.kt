package com.idiotleon.leetcode.lvl6.lc0741
...
class SolutionApproach0DFSMemo {
    ...
    private fun dfs(
        row1: Int, col1: Int, col2: Int, grid: Array<IntArray>, memo: Array<Array<IntArray>>
    ): Int {
        ...
        var max = maxOf(
            maxOf(
                dfs(row1, col1 - 1, col2 - 1, grid, memo), dfs(row1 - 1, col1, col2, grid, memo)
            ), maxOf(
                dfs(row1 - 1, col1, col2 - 1, grid, memo), dfs(row1, col1 - 1, col2, grid, memo)
            )
        )
