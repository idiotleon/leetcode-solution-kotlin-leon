package com.idiotleon.leetcode.lvl4.lc0140
...
class Solution0DfsMemo {
    ...
    private fun dfs(
        str: String, wordSet: HashSet<String>, memo: HashMap<String, List<String>>
    ): List<String> {
        ...
        for (idx in str.indices) {
            ...
            for (nextSub in nextSubs) {
                res.add("$nextSub $curSub")
            }
        }
